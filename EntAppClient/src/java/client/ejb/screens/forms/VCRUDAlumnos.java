...
public class VCRUDAlumnos extends javax.swing.JFrame {
    ...
    public VCRUDAlumnos(Carrera carrera,
            AlumnoServiceRemote servicioAlumnos,
            CarreraServiceRemote servicioCarreras) {
    ...
    private void initComponents() {
        ...
        lbNombreCarrera.setText(carrera.getNombre());
        ...
        btnActualizarListaAlumnos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnActualizarListaAlumnosMouseClicked(evt);
            }
        });
        ...
        panelEditorLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelEditorLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tabEditor, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnAgregarCarreraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarCarreraMouseClicked
        this.formAgregarAlumnos = 
            new VFormAgregarAlumnos(this.carrera, 
                    this.servicioCarreras, 
                    this.servicioAlumnos);
                ...
                if (row >= 0) {
                    int eleccion = 
                        javax.swing.JOptionPane.showOptionDialog(this,
                            "¿Está seguro de dar de baja el alumno '" +
                                modeloTabla.getValueAt(row, 1) + "' del "
                                + "curso?",
    ...
    private void tbAlumnosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbAlumnosMouseClicked
        ...
        if (row >= 0) {
            ...
            alumno.setNombre(modeloTabla.getValueAt(row, 1).toString());
            ...
            alumno.setEmail(modeloTabla.getValueAt(row, 4).toString());
            updateObjectsWhenRowSelected(alumno);
        }
    ...
    private void btnActualizarListaAlumnosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnActualizarListaAlumnosMouseClicked
        removeAllRowsTable();
        addRowsTable();
    }//GEN-LAST:event_btnActualizarListaAlumnosMouseClicked

    private void initEvents() {
        this.btnBorrarAlumno.setEnabled(false);
        this.btnActualizarListaAlumnos.setEnabled(true);
    }
    ...
    private void updateObjectsWhenRowSelected(Alumno alumno) {
        this.txtMatricula.setText(alumno.getMatricula());
        this.txtNombreAlumno.setText(alumno.getNombre());
    ...
    private void addRowsTable() {
        List<Alumno> alumnos = 
            this.servicioCarreras.obtenerInscritos(this.carrera);
        this.carrera.setAlumnoList(alumnos);
        if (!alumnos.isEmpty()) {
